...
# Allowed image extensions for the file serving endpoint
_IMAGE_EXTENSIONS = {".png", ".jpg", ".jpeg", ".gif", ".webp", ".svg", ".bmp", ".ico"}


@app.get("/files/{file_path:path}")
async def serve_file(file_path: str):
    """Serve image files generated by the agent from the working directory.

    Only serves image files to prevent arbitrary file access.
